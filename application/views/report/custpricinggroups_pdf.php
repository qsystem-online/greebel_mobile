...
<html>
<head>
  <title>Report Master Cust Pricing Groups</title>
  <style type="text/css">
...
<body>
  ...
  <h3 text-align= "center">Table Master Cust Pricing Groups</h3>
	...
	<div id="outtable">
	  <table>
        ...
        <?php foreach($datas as $data): ?>
          <tr>
            <td><?php echo $no; ?></td>
            <td><?php echo $data['CustPricingGroupId']; ?></td>
            <td><?php echo $data['CustPricingGroupName']; ?></td>
            <td><?php echo $data['PercentOfPriceList']; ?></td>
            <td><?php echo $data['DifferenceInAmount']; ?></td>
          </tr>
        <?php $no++; ?>
        <?php endforeach; ?>
	  	</tbody>
